...
<#assign title="XK-Note | 一个集各种神奇功能的云笔记">
<#assign body_class="xknote-welcome">
<#include "_layout.ftl">
...
<@header>
    ...
    <section class="navbar-section">
        <@security.authorize access="isAuthenticated()">
            <a class="btn btn-link" href="/home">开始创作</a>
            <form action="/logout" method="post">
                <@note.formCsrf />
                <button class="btn btn-link" type="submit">登出</button>
            </form>
        </@security.authorize>
...
<@main>
    <div class="welcome-header">
        ...
        <div>
            <a class="label" href="https://github.com/syfxlin"
            >Github</a
            >
            <a class="label" href="https://blog.ixk.me/xknote.html"
            >Introduction</a
            >
    ...
    <div class="welcome-body">
        <div class="xknote-container columns grid-md">
            ...
            <div class="column col-4 col-md-12">
                <h2>
                    <img
                            src="/static/svg/cloud-download.svg"
                            alt=""
                    />
                    导出笔记
                </h2>
...
<@footer>
    <div class="xknote-copyright bg-gray">
        <p>
            Copyright © 2019
            <a href="https://github.com/syfxlin/xknote">XK-Note</a>
        </p>
        <p>
            All rights reserved <a href="https://ixk.me">Otstar Lin</a>
        </p>
    </div>
</@footer>